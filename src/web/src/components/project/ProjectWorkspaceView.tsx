...
import { Activity, Check, ChevronDown, CircleAlert, Copy, Download, FileCode2, FolderOpen, GitBranch, Play, RefreshCw, Search, ShieldCheck, TerminalSquare } from 'lucide-react'
